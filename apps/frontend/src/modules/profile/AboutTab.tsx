...
import { Info, Rocket, HeartHandshake, Lock, ChevronRight } from "lucide-react";
      ...
      >
        <div className="space-y-3">
          <p
            ...
            style={{ color: "var(--text-primary)" }}
          >
            O <strong>Arandu</strong> é uma plataforma completa de estudos
            criada para ajudar você a organizar, revisar e dominar qualquer
            conteúdo — do vestibular à faculdade, de provas a concursos.
          </p>
          <p
            className="text-sm leading-relaxed"
            style={{ color: "var(--text-secondary)" }}
          >
            Reúna anotações, flashcards, questões e simulados em um só lugar,
            planeje sua rotina com agenda, cronograma e pomodoro, e acompanhe
            seu progresso com estatísticas e repetição espaçada (SM-2).
          </p>
      ...
      >
        <div className="flex flex-col gap-3">
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            O Arandu é um projeto de código aberto mantido com dedicação. Se
            você gostou da plataforma e quer apoiar financeiramente o
            desenvolvimento contínuo — cobrindo servidores, infraestrutura e
            novas funcionalidades — sua contribuição faz toda a diferença. 💜
          </p>
          <div
